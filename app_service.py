...
# Antipatrón 1: Credenciales expuestas directamente en el código fuente
...
def procesar_usuarios(lista_usuarios):
    ...
    # Demasiados bloques condicionales anidados que dificultan la
...
def calcular_impuesto_zona_a(monto):
    ...
    # Bloques idénticos copiados y pegados que violan el principio DRY
...
def calcular_impuesto_zona_b(monto):
    # Duplicación explícita del bloque anterior cambiando únicamente el
...
def operacion_insegura_y_muerta():
    ...
    # Intentar ejecutar una división por cero (falla en tiempo de
